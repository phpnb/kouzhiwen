...
use app\admin\course\model\CourseType as model;
use app\admin\root\controller\Common;

class Coursetype extends Common{
    protected $checkVal = []; 
    /**
     * [_initialize 初始化]
     */

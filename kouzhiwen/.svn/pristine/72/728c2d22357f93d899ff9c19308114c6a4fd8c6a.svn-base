<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:81:"/www/wwwroot/kouzhiwen/public/../application/admin/info/view/enterprise/edit.html";i:1539915590;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:84:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/webuploader.html";i:1506306702;s:83:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/dateplugin.html";i:1506306702;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <form action="" class="verify-form rform">
        <table class="table">
            ...
            <tr>
                ...
                <td><input name="student" value="<?php echo $data['student']; ?>" type="text" class="form-control w400" datatype="n"></td>
            </tr>
            <tr>
                <th class='msg'>到期时间</th>
                <td>
                    <input type="text" id="time-expire" name="expire" class="date-plugin form-control w200" value="<?php echo $data['expire']; ?>" placeholder="选择日期" datatype="*">
                </td>
            </tr>
            <tr>

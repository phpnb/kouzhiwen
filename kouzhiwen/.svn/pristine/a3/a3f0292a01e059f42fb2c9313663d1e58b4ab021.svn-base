<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/introduce/edit.html";i:1539779304;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:84:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/webuploader.html";i:1506306702;s:80:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/ueditor.html";i:1506306702;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <form action="" class="verify-form rform">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <select name="type" class="form-control w400" style="width: 425px;">
                        ...
                        <option value="<?php echo $v; ?>" <?php if(($v==$data['type'])): ?>selected<?php endif; ?>><?php echo $k; ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <div id="fileList" class="uploader-list">
                        <div class="upload-ts">
                            <img src="<?php echo $data['cover_img']; ?>" width="200" alt="">
            ...
            <tr>
                ...
                <td><input name="name" value="<?php echo $data['name']; ?>" type="text" class="form-control w400" maxlength="50" datatype="*"></td>
            </tr>
            <tr>
                <th width="150" class="msg">作者</th>
                <td><input name="author" value="<?php echo $data['author']; ?>" type="text" class="form-control w400" maxlength="20" datatype="*"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea name="contents" style="width:600px;height:300px;" datatype="*" id="contentsEditor"><?php echo $data['contents']; ?></textarea>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <label class="checkbox-inline">
                        <input type="radio" name="is_recommend" <?php if(($data['is_recommend']==$v)): ?>checked<?php endif; ?>  value="<?php echo $v; ?>">
                        &nbsp;&nbsp;<?php echo $k; ?>
                    </label>
                    <?php endforeach; ?>
                </td>

    ...
    <form action="" class="verify-form rform">
        <table class="table">
            ...
            <tr>
                <th class='msg'>内容</th>
                <td>
                    <textarea name="content" style="width:800px;height:400px;" datatype="*" id="contentEditor"></textarea>
                </td>
            </tr>
            <tr>
                <th class='msg'>图片</th>

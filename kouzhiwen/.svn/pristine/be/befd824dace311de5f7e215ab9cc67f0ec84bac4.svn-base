<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/introduce/index.html";i:1539779322;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
        ...
        <table class="table">
            ...
            <?php if((!empty($data))): foreach($data AS $v): ?>
                <tr>
                    ...
                    <td><img src="<?php echo $v['cover_img']; ?>" width="80"> </td>

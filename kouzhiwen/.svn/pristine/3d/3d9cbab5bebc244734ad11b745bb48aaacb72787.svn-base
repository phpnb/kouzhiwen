<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\study\kouzhiwen\public/../application/teacher/root\view\index\index.html";i:1560313160;s:75:"D:\study\kouzhiwen\public/../application/admin/root\view\common/header.html";i:1560313173;s:75:"D:\study\kouzhiwen\public/../application/admin/root\view\common/footer.html";i:1560313174;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div id="menu">
    ...
    <a href="<?php echo url('teacher/course/study/index',['id'=>$user['id']]); ?>" target="iframe">班级列表</a>
            <?php endif; if((in_array(1,$identity) || in_array(3,$identity))): ?>
    <a href="<?php echo url('teacher/course/study/kecheng',['id'=>$user['id']]); ?>" target="iframe">课程列表</a>
                <a href="<?php echo url('info/teacherarticle/index',['type'=>1]); ?>" target="iframe">研究动态</a>
                <a href="<?php echo url('course/study/user_quiz',['id'=>$user['id']]); ?>" target="iframe">主讲课程</a>
                ...
                <a href="<?php echo url('course/study/qianbao',['id'=>$user['id']]); ?>" target="iframe">钱包</a>
            <?php endif; ?>
                ...
                <a href="<?php echo $url; ?>/im/im.html?id=<?php echo $user['id']; ?>" target="_blank">IM聊天</a>

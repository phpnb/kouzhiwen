    ...
    a.fn.jalendar = function(t) {
        function e() {
            ...
            for (var d = 1; d <= T[w]; d++) {
                e++;
                var r;
                "dd-mm-yyyy" == s.dateType ? r = d + "-" + (w + 1) + "-" + E: "mm-dd-yyyy" == s.dateType ? r = w + 1 + "-" + d + "-" + E: "yyyy-mm-dd" == s.dateType ? r = E + "-" + (((w + 1) < 10) ? '0' + (w + 1) : (w + 1)) + "-" + (d < 10 ? '0' + d : d): "yyyy-dd-mm" == s.dateType && (r = E + "-" + d + "-" + (w + 1)),

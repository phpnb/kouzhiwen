<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/course/view/study/index.html";i:1557479270;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
            ...
            <?php if((!empty($data))): foreach($data AS $v): ?>
                <tr>
                    ...
                    <td class="operation">
                        ...
                        <a href="<?php echo url('notice',['id'=>$v['id']]); ?>" target="frame_dispose"
                           onclick="open_frame('班级通知', 100, 100, true)"
                           class="glyphicon glyphicon-bullhorn" title="班级通知"></a>
                        <a href="<?php echo url('hotspot',['id'=>$v['id']]); ?>" target="frame_dispose"
                           onclick="open_frame('班级热点', 100, 100, true)"
                           class="glyphicon glyphicon-list-alt" title="班级热点"></a>
                        <a href="<?php echo url('adduser',['id'=>$v['id']]); ?>" target="frame_dispose"
                           onclick="open_frame('选择用户', 100, 100, true)"
                           class="glyphicon glyphicon glyphicon-plus" title="选择用户"></a>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/www/wwwroot/kouzhiwen/public/../application/admin/info/view/tasks/index.html";i:1556587530;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <ul class="clearfix menu">
        <li>
            <a
                    ...
                    onclick="open_frame('添加任务', 100, 100, true);">
                添加任务
            </a>
        </li>
    ...
    <div class="table-box">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <?php if(($v['statu']==1)): ?>
                    <span class="label label-danger f12">未完成</span>
                    <?php elseif(($v['statu']==2)): ?>
                    <span class="label label-success f12">已完成</span>

                    <?php endif; ?>
                </td>

                <td class="operation">
                    <a href="<?php echo url('look',['id'=>$v['uid']]); ?>" target="frame_dispose"
                       onclick="open_frame('查看任务', 100, 100, true)"
                       class="glyphicon glyphicon-list-alt" title="查看任务"></a>

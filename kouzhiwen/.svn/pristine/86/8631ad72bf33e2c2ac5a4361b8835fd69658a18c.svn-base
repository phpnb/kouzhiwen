<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/banner/index.html";i:1539849370;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <div class="table-box">
        <div class="table-header clearfix">
            ...
            <!--<form action="" method="get" class="clearfix fr">-->
                <!--<input type="text" value="<?php echo $keywords; ?>" name="keywords" class="form-control search-in" placeholder="关键词">-->
        ...
        <table class="table">
            ...
            <?php if((!empty($data))): foreach($data AS $v): ?>
                <tr>
                    ...
                    <td><?php echo $v['id']; ?></td>
                    <?php if($checkVal['enterprise_id'] == '0'): ?>
                    <td><?php echo $checkVal['classify_idVal'][$v['classify_id']]; ?></td>
                    <?php endif; ?>
                    <td><?php echo $v['pid']; ?></td>
                    <td><?php echo $checkVal['mold'][$v['mold']]; ?></td>
                    <td><?php echo $checkVal['type'][$v['type']]; ?></td>
                    <td><img src="<?php echo $v['img_url']; ?>" width="80"></td>

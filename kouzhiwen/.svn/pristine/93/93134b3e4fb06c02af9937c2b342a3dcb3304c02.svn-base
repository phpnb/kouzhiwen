...
//        dump($this -> user['uid']);
    ...
    public function accept()
    {
        ...
        $UserNotice->addData(['uid'=>$this->param['uid'],'title'=>'问题被采纳','content'=>'您的回答被提问者采纳。','reading'=>0,'created_at'=>$time]);
    ...
    public function reward()
    {
        ...
        $UserNotice->addData(['uid'=>$this->param['uid'],'title'=>'打赏通知','content'=>'您的提问被打赏。','reading'=>0,'created_at'=>$time]);

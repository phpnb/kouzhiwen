<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/feedback/index.html";i:1535972618;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <div class="table-box">
        <div class="table-header clearfix">
            ...
            <form action="" method="get" class="clearfix fr">
                <input type="text" value="<?php echo $keywords; ?>" name="keywords" class="form-control search-in" placeholder="反馈内容">

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"/www/wwwroot/kouzhiwen/public/../application/teacher/info/view/teacherarticle/index.html";i:1558315857;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div id="right_content">
    ...
    <ul class="clearfix menu">
        ...
        <li>
            <a
                href="<?php echo url('add',['type'=>$type]); ?>" target="frame_dispose"
        ...
        <table class="table">
            ...
            <?php if((!empty($data))): foreach($data AS $v): ?>
                <tr>
                    ...
                    <td class="operation">
                        <?php if(($type==2)): ?>
                        <a href="<?php echo url('evaluate',['id'=>$v['id'],'type'=>$type]); ?>" target="frame_dispose"
                          onclick="open_frame('点评', 100, 100, true)"
                          class="glyphicon glyphicon-eye-open" title="点评"></a>
                        <?php endif; ?>
                        <a href="<?php echo url('edit',['id'=>$v['id'],'type'=>$type]); ?>" target="frame_dispose"

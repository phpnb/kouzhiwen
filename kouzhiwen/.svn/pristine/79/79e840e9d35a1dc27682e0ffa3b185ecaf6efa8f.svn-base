...
class Loader
{
     ...
     * @throws ClassNotFoundException
     */
    public static function controller($name, $layer = 'common', $appendSuffix = false, $empty = '', $has_child = false)
    {
        if (false !== strpos($name, '\\')) {
            $class  = $name;
            $module = Request::instance()->module();
            ...
            $class = self::parseClass($module, $layer, $name, $appendSuffix, $has_child);
        }
     ...
     * @return mixed
     */
    public static function action($url, $vars = [], $layer = 'common', $appendSuffix = false)
    {
        $info   = pathinfo($url);
     ...
     * @param string $layer  层名 common model ...
     * @param string $name   类名
     * @param bool   $appendSuffix
     * @return string
     */
    public static function parseClass($module, $layer, $name, $appendSuffix = false, $has_child = false)
    {

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/advertisements/index.html";i:1548051707;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
        ...
        <table class="table">
            ...
            <?php if((!empty($data))): foreach($data AS $v): ?>
                <tr>
                    ...
                    <td><img src='<?php echo $v['img']; ?>' style='max-width:100px;'></td>
                    <td><?php echo $v['price']; ?></td>

                    <td class="operation">
                        <a href="<?php echo url('aduser',['id'=>$v['id']]); ?>" target="frame_dispose"
                           onclick="open_frame('修改数据', 100, 100, true)"
                           class="glyphicon glyphicon-user" title="报名成员"></a>

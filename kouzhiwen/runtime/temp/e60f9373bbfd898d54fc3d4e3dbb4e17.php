<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/www/wwwroot/kouzhiwen/public/../application/admin/info/view/tasks/edit.html";i:1556587530;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div id="right_content">
    <form action="" method="" class="verify-form rform" go="">
        <table class="table">
            <tr>
                <th>姓名</th>
                <th><?php foreach($pp AS $p): ?>   <?php echo $p['name']; endforeach; ?></th>
            </tr>
            <tr>
                <th>班级</th>
                <th>课程</th>
                ...
                <td class="son_check_<?php echo $val['id']; ?> son_check">
                    <div class="clearfix mt5">
                        ...
                        <label class="checkbox-inline">
                            <input type="checkbox" name="cid[]" value="<?php echo $vall['cid']; ?>" <?php foreach($cid AS $j): if($vall['cid'] == $j): ?> checked="checked" <?php endif; endforeach; ?> > <?php echo $vall['title']; ?>
                        </label>
                        <?php endforeach; ?>
                    </div>
                </td>

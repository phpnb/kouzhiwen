<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/www/wwwroot/kouzhiwen/public/../application/teacher/course/view/study/paper.html";i:1544955759;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
        ...
        <table class="table">
            ...
            <?php if((!empty($data))): foreach($data AS $v): ?>
                <tr>
                    ...
                    <td class="operation">
                        <a href="<?php echo url('paper_user',['id'=>$v['id']]); ?>" target="frame_dispose"

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/www/wwwroot/kouzhiwen/public/../application/teacher/course/view/study/user_quiz.html";i:1552872643;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div id="right_content">
    ...
    <ul class="clearfix menu">
        ...
        <li>
            <a
                    href="<?php echo url('add_user_quiz'); ?>" target="frame_dispose"
    ...
    <div class="table-box">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td class="operation">
                    <a href="<?php echo url('edit_user_quiz',['id'=>$v['id']]); ?>" target="frame_dispose"
                       onclick="open_frame('修改数据', 100, 100, true)"
                       class="glyphicon glyphicon-edit" title="编辑"></a>
                    <a class="glyphicon glyphicon-trash"
                       onclick="ajax_post('<?php echo url('delUserQuiz'); ?>',{'id':<?php echo $v['id']; ?>});" title="删除"></a>

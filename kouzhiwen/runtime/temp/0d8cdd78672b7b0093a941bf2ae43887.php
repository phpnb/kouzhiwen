<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/www/wwwroot/kouzhiwen/public/../application/admin/course/view/classcourse/index.html";i:1547452935;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
        ...
        <table class="table">
            ...
            <?php if((!empty($data))): foreach($data AS $v): ?>
                <tr>
                    ...
                    <td>
                        <?php if((!empty($checkVal['teacher_idVal'][$v['teacher_id']]))): ?>
                            <?php echo $checkVal['teacher_idVal'][$v['teacher_id']]; endif; ?>
                    </td>
                    ...
                    <td>
                        <?php if((!empty($checkVal['statusVal'][$v['status']]))): ?>
                            <?php echo $checkVal['statusVal'][$v['status']]; endif; ?>
                    </td>

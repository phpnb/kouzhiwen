<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/www/wwwroot/kouzhiwen/public/../application/teacher/info/view/user/studyrecord.html";i:1551366580;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div id="right_content">
    ...
    <ul class="clearfix menu">
        ...
        <li><a href="<?php echo url('nodetails',['uid'=>$uid,'type'=>6]); ?>" <?php if(($type==6)): ?>class="this"<?php endif; ?>>主讲课程</a></li>
    </ul>
    <!-- 菜单 -->
    <div class="table-box">

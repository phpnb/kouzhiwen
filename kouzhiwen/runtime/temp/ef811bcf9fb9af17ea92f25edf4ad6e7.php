...
<div id="right_content">
    ...
    <div class="table-box">
        ...
        <table class="table">
            ...
            <tr>
               <p style="color: red;font-size: 20px;">共有学员（<?php echo $res['count']; ?>）名</p>

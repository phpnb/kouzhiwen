<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:82:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/information/edit.html";i:1540456116;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/header.html";i:1548252300;s:84:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/webuploader.html";i:1506306702;s:80:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/ueditor.html";i:1506306702;s:79:"/www/wwwroot/kouzhiwen/public/../application/admin/root/view/common/footer.html";i:1506306702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <form action="" class="verify-form rform">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <select name="classify_id" class="form-control w426" datatype="*">
                        ...
                        <option value="<?php echo $v; ?>" <?php if(($v==$data['classify_id'])): ?>selected<?php endif; ?>><?php echo $k; ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><input name="author" value="<?php echo $data['author']; ?>" type="text" class="form-control w400" datatype="*"></td>
            </tr>
            <tr>
                <th class='msg'>内容</th>
                <td>

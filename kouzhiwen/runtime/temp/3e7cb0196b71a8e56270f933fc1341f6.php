<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\study\kouzhiwen\public/../application/admin/info\view\teacher\edit.html";i:1565140878;s:75:"D:\study\kouzhiwen\public/../application/admin/root\view\common/header.html";i:1560313173;s:80:"D:\study\kouzhiwen\public/../application/admin/root\view\common/webuploader.html";i:1560313173;s:75:"D:\study\kouzhiwen\public/../application/admin/root\view\common/footer.html";i:1560313174;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <form action="" class="verify-form rform">
        <table class="table">
            ...
            <tr id="url1">
                ...
                <td><input name="synopsis" value="<?php echo $data['synopsis']; ?>" type="text" class="form-control w400"></td>
            </tr>
            <tr>
                <th class='msg'></th>
                <td>
                    <div id="synopsis-list" class="uploader-list_video" datnum="one" >
                        <div class="upimg-box">
                            <input type="hidden"  value="<?php echo $data['synopsis']; ?>" datatype="/^.*?$/" nullmsg="请上传视频">
                            <notempty name="video">

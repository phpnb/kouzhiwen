...
class WxPayApi
{
     ...
     * @return array
     */
    public static function transfers($inputObj,$timeOut=6,$ssl=array(),$key)
    {
        ...
        $response = self::postXmlCurl($xml, $url, true, $timeOut,$ssl);

        $result = WxPayResults::Init($response,$key,false);
	 ...
	 * @throws WxPayException
	 */
	private static function postXmlCurl($xml, $url, $useCert = false, $second = 30,$ssl=array())
	{		
		$ch = curl_init();
		//设置超时
